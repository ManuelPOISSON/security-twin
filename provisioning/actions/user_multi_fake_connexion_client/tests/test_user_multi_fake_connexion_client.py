...
from provisioning.actions.user_multi_fake_connexion_client import (
    UserMultiFakeConnexionClient,
)
from provisioning.Chronology import Chronology
from provisioning.ChronologyRunner import ChronologyRunner

REQUIRED_ACTIONS = PRIOR_ACTIONS + [UserMultiFakeConnexionClient]
...
def test_user_multi_fake_connexion_client(
