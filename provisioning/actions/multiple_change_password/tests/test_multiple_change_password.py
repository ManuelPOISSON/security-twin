...
from provisioning.actions.multiple_change_password import MultipleChangePassword
from provisioning.Chronology import Chronology
from provisioning.ChronologyRunner import ChronologyRunner

REQUIRED_ACTIONS = PRIOR_ACTIONS + [MultipleChangePassword]
...
def test_multiple_change_password(
