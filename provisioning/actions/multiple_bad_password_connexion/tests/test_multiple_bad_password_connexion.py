...
from provisioning.actions.multiple_bad_password_connexion import (
    MultipleBadPasswordConnexion,
)
from provisioning.Chronology import Chronology
from provisioning.ChronologyRunner import ChronologyRunner

REQUIRED_ACTIONS = PRIOR_ACTIONS + [MultipleBadPasswordConnexion]
...
def test_multiple_bad_password_connexion(
