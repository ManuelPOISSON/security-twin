...
class SoftwareRegistry:
    registry: str
    softwares: list[Software] = field(default_factory=lambda: [])
...
class ModelDTO:
    ...
    ad_data: AdData
    windows_local_data: dict[str, LocalComputerData] = field(default_factory=lambda: {})
    linux_local_data: list[LinuxData] = field(default_factory=lambda: [])
